...
async function selfTest() {
  ...
  try {
    // OLD_CHUNK_LOOP declares `completed` itself. Keep the fixture's surrounding
    // scope free of a second declaration so the syntax check validates the
    // production transform rather than failing on synthetic test scaffolding.
